...
class StagesControllerTest < ActionController::TestCase
  ...
  test "should create stage" do
    assert_difference('Stage.count') do
      post :create, stage: { difficulty: @stage.difficulty, landmark: @stage.landmark, miles: @stage.miles, number: @stage.number }
    end
  ...
  test "should update stage" do
    put :update, id: @stage, stage: { difficulty: @stage.difficulty, landmark: @stage.landmark, miles: @stage.miles, number: @stage.number }
    assert_redirected_to stage_path(assigns(:stage))
  end
