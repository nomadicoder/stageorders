...
RSpec.describe "support_units/new", :type => :view do
  before(:each) do
    assign(:support_unit, SupportUnit.new(
      :team_id => 1,
      :support_type_id => 1,
  ...
  it "renders new support_unit form" do
    render

    assert_select "form[action=?][method=?]", support_units_path, "post" do
